...
مهمتك: تحليل وثيقة السياسة والإجراءات الطبية المرفقة وتوليد تحليل تنفيذي فائق الاحترافية باللغة العربية، دقيق وشامل ومقسم بحسب الهيكل الإلزامي الصارم، مع التأكد من الربط المباشر ببنود معايير GAHAR 2025 والدليل القومي 2020:
...
1. بطاقة السياسة (Policy Card):
   ...
   - المعايير المرجعية ذات الصلة: يجب ذكر بنود معايير جهار (GAHAR 2025)، الدليل القومي لمكافحة العدوى 2020، إضافة إلى CBAHI / JCI / OSHA بدقة مع أرقام البنود إن أمكن.

2. الهدف الأساسي ونطاق التطبيق (Purpose & Scope):
   - الهدف العام للسياسة والمبرر الإكلينيكي / التنظيمي وفق متطلبات الجودة والاعتماد
   - نطاق التطبيق (من تشملهم السياسة وأين تُطبق)
   - الفئات المستثناة (إن وجدت) والمحددات الصارمة

3. المسؤوليات والأدوار المحددة (Roles & Responsibilities):
   - تفصيل واضح للأدوار لكل جهة معنية (مثل: الإدارة الطبية، فريق ولجنة مكافحة العدوى، إدارة الجودة والاعتماد، ضابط السلامة والصحة المهنية، الأطباء، الكوادر التمريضية، فنيو المختبر، الخدمات المعاونة).

4. خطوات العمل التنفيذية (Standard Operating Procedures - SOPs):
   - خطوات متسلسلة بدقة ومنطقية ومطابقة لأدلة العمل المعتمدة ومقسمة إلى مراحل:
     أ) مرحلة ما قبل الإجراء والتجهيز (Pre-procedure / Preparation)
     ب) مرحلة التنفيذ والإجراءات الميدانية خطوة بخطوة بالأسلوب المانع للتلوث (Execution & Aseptic Technique)
     ج) مرحلة ما بعد الإجراء والتوثيق والتخلص الآمن من النفايات (Post-procedure, Documentation & Waste Disposal)

5. الإرشادات الحرجة والتحذيرات الصارمة (Safety Warnings & Critical Steps):
   - نقاط المراقبة والتحكم الحرجة (Critical Control Points - CCPs)
   - مصفوفة الممارسات الإلزامية والمحظورات الصارمة (DOs and DON'Ts)
   - بروتوكول الاستجابة الفورية عند حدوث خلل أو تعرض طارئ أو وخز مهني (Immediate Exposure / Incident Protocol)
...
7. معايير الامتثال والتدقيق والمؤشرات (Compliance, Audit Checklist & KPIs):
   - قائمة تدقيق جودة ومطابقة ميدانية (Audit Checklist) مطابقة لمعايير التفتيش والاعتماد في GAHAR 2025 والدليل القومي مع أدلة الإثبات المطلوبة.
   ...
   - ثغرات الامتثال المحتملة وتوصيات التحسين لسد الفجوات لتجهيز المنشأة لزيارات الاعتماد الرسمية.`;
