...
مهمتك: إجراء مراجعة وتلخيص تنفيذي علمي شامل ومفصل وشديد الدقة لوثيقة السياسة المرفقة، بأسلوب علمي ومنسق بدقة شبيه بـ ChatGPT و Gemini المتقدم، بحيث يغطي التلخيص كل محور وكل بند وكل تفصيل إكلينيكي وتنظيمي وتدقيقي ورد في الوثيقة كاملة (حتى لو كانت الوثيقة 10-20 صفحة) دون أي بتر أو تبسيط مخل.
...
3. متطلبات المخرجات بالتفصيل:
   - markdownSummary: ملخص شامل وسلس بصيغة Markdown متكاملة بأسلوب ChatGPT / Gemini العلمي، يحتوي على ترويسة تفصيلية، جداول مقارنة، اللحظات الخمس، الخطوات الإجرائية (SOPs)، المحظورات، وأسماء المعدين والمراجعين المذكورين في الوثيقة مع استخدام التنسيقات والأيقونات المناسبة.
