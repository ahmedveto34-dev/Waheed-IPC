...
مهمتك: إعداد وثيقة "المراجعة النهائية والملخص التنفيذي المركز (A4 Executive Review Brief)" لسياسة الرعاية الصحية، مركزاً على النقاط الجوهرية والحرجة التي يحتاجها الممارس الصحي والمقيّم الميداني (Surveyor / Auditor) بصياغة عربية طبية رفيعة ومنسقة بدقة لمقاسات ورق A4:

1. الملخص التنفيذي والنقاط الذهبية (Executive Summary Snippet):
   - ملخص شديد التركيز والأهمية (2-3 فقرات مركزة) يبرز القواعد الذهبية للسياسة، المبرر الإكلينيكي الحاسم، وتوجيهات السلامة الفورية.

2. بطاقة السياسة (Policy Card):
   - اسم السياسة الرسمي (بالعربية والإنجليزية)، الكود، المجال، الأقسام المعنية، والربط الدقيق بمعايير GAHAR 2025 والدليل القومي مع أرقام البنود.

3. الهدف ونطاق التطبيق (Purpose & Scope):
   - الهدف الأساسي والمبرر الإكلينيكي، الفئات المستهدفة، والاستثناءات والمحددات الصارمة.

4. مصفوفة الأدوار والمسؤوليات (Roles & Responsibilities):
   - المسؤوليات الدقيقة لفرق الجودة ومكافحة العدوى والأطباء والتمريض.

5. خطوات العمل القياسية (SOPs):
   - تسلسل ثلاثي المراحل: (ما قبل الإجراء، التنفيذ المباشر بالأسلوب المانع للتلوث، ما بعد الإجراء والتخلص الآمن).

6. التحذيرات الحرجة والمحظورات (Critical Warnings & DOs / DON'Ts):
   - نقاط المراقبة الحرجة (CCPs)، مصفوفة الممارسات الإلزامية (DOs) والمحظورات الصارمة (DON'Ts)، وبروتوكول الاستجابة الفورية للطوارئ وحوادث التعرض المهني.

7. مخطط تدفق العمليات (Mermaid.js Flowchart):
   - كود flowchart TD متكامل وواضح.

8. قائمة التدقيق الميداني ومؤشرات الأداء (Audit Checklist & KPIs):
   - بنود فحص محددة مع دليل الإثبات المطلوب لزيارات الاعتماد، ومؤشرات الأداء المقاسة مع معادلاتها والمستهدف الرقمي.`;
